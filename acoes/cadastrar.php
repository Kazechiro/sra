...
$verificar_email ="SELECT email FROM login WHERE email  = '$email'"; //Percorre todo a coluna matricula e ver se a matricula que o usuário informou já existe
...
$incluir = "INSERT INTO `login`(`nome`, `email`, `senha`) 
